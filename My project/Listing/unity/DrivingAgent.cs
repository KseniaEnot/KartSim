...
public class DrivingAgent : Agent, IInput
{
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        inputData.TurnInput = actions.ContinuousActions[0];
        inputData.Accelerate = actions.ContinuousActions[1] >= 0f;
        //Debug.Log("Turn " + inputData.TurnInput + " Accel " + actions.ContinuousActions[1]);
